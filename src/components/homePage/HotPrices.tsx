...
const HotPrices: React.FC<Props> = ({ preparedPhones }) => {
  const preparedPhonesToHotPricdes = preparedPhones.filter((phone: Phone) => phone.discount !== 0).sort((a: Phone, b: Phone) => (b.price * (b.discount / 100)) - (a.price * (a.discount / 100)));
